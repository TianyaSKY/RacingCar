...
# -- 奖励函数 ---
REWARD_STEP_PENALTY = -0.3
REWARD_COLLISION_PENALTY = -200  # 碰撞惩罚
REWARD_OUT_OF_BOUNDS_PENALTY = -200 # 出界惩罚
REWARD_SPEED_REWARD = 0.8 # 速度奖励
REWARD_TRACK_CENTER_REWARD = 0.2 # 保持在赛道上奖励